function [Y] = mot_pre_association(init_image_set,detections,Y,start_frame,end_frame)
...
for q=start_frame+1:end_frame
    ...
    prev_img = init_image_set{q-1};
    cur_det = detections(q);
    cur_img = init_image_set{q};
    asso_idx = [];
